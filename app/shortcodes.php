...
class DTCoreShortcodesDefination {
	...
	function dt_sc_timeline_item( $atts, $content = null ) {
		...
		$out = '<div class="dt-sc-timeline-content">
					...
					$out .= "<div style='display:table;'>".$content.'</div></p>
	...
	function dt_sc_slider_search( $atts, $content = null ) {
		...
		if(dttheme_get_page_permalink_by_its_template('tpl-courses-search.php') != '') {	
			...
			$srch_str = 'location';
			$action = dttheme_get_page_permalink_by_its_template('coache_search.php');
...
$out="";
					$out .= '<h4 align="center" style="color: #000059;

font-size: 35px;

">Begin <i>and</i> Elevate</h4>';

			$out .= '<h4 align="center" style="color: #000059;

font-size: 30px;

">Coaches and Trainers for LIFESTYLE and TRADITIONAL sports</h4>';

		$out .= '<div class="slider-search" style="margin-bottom:15px;">   

					<form method="get" id="courses-search" class="courses-search" action="'.$action.'">  

					<select name="sport_category" id="sport_categoryss" required>
                                  <option value="">Sports Categories </option>
					<option value="Motocross">Motocross</option>
						...
						<input id="'.$srch_str.'" name="'.$srch_str.'" type="text"  placeholder="'.__('Zip,Address or city', 'dt_themes').'" required />

					

						<input type="button" value="" onclick="srch_show();">
...
"> Join the growing number of Athletes and Enthusiasts that have reached their goals with ConnectSport</h4>';
