...
class GroupsController extends JoshController
{
    ...
    public function postCreate()
    {
        ...
        if ($role = Sentinel::getRoleRepository()->createModel()->create([
            ...
            return Redirect::route('companyes')->with('success', Lang::get('Company Create successfully.'));
        }

        // Redirect to the group create page
        return Redirect::route('create/companye')->withInput()->with('error', Lang::get('groups/message.error.create'));
    }
    ...
    public function postEdit($id = null)
    {
        ...
        if ($group->save()) {
            ...
            // Redirect to the group page
            return Redirect::route('update/companye', $id)->with('error', Lang::get('Error in update'));
        }
    ...
    public function getDelete($id = null)
    {
        try {
            ...
            // Redirect to the group management page
            return Redirect::route('companys')->with('error', Lang::get('Error in update', compact('id')));
        }
    }
