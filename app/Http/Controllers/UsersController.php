...
$user_id = DB::table('users')->orderby('id', 'desc')->first();
			...
			DB::table('users')
            ->where('id', $user_id->id)
            ->update(['ROLE'=>Input::get('role'),'bio'=>Input::get('bio'),'gender'=>Input::get('gender'),'country'=>Input::get('country'),'state'=>Input::get('state'),'city'=>Input::get('city'),'address'=>Input::get('address'),'postal'=>Input::get('postal'),'COMPANY_ID'=>Input::get('comp')]);
