                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-wizard form-horizontal" action="{{ route('create/currency') }}" method="POST"  id="wizard-validation"  enctype="multipart/form-data">
                                <!-- CSRF Token -->
                                ...
                                <section style="height:400px !important;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
											...
											{
											?>
                                               <option value="<?php echo $currency_code->code?>"><?php echo $currency_code->code?></option>
                                            <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="famnt" name="famnt" type="text" class="form-control decimal required" value="{!! Input::old('famnt') !!}" />
                                        </div>
                                    </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="tamnt" name="tamnt" type="text" class="form-control decimal required" value="{!! Input::old('tamnt') !!}" />
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="exrate" name="exrate" type="text" class="form-control decimal required" value="{!! Input::old('exrate') !!}" />
                                        </div>
                                    </div>
