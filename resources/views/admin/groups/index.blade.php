                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('update/company', $role->id) }}">
                                            ...
                                            @if ($role->id !== 1)
                                                ...
                                                @else
                                                    <a href="{{ route('confirm-delete/company', $role->id) }}" data-toggle="modal" data-target="#delete_confirm">
...
<div class="modal fade" id="delete_confirm" tabindex="-1" role="dialog" aria-labelledby="user_delete_confirm_title" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <button type="button" onclick="window.location='{{ route('confirm-delete/company', $role->id) }}'" class="btn btn-danger">Delete</button>
    </div>
  </div>
</div>
