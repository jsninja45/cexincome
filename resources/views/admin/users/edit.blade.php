...
<section class="content">
    ...
    <div class="row">
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
											...
											{
											?>
                                               <option value="<?php echo $countrys?>"  @if($user->country === $countrys) selected="selected" @endif><?php echo $countrys?></option>
                                            <?php } ?>
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <select class="form-control " title="Select group..." name="role" id="role" required>

                                                <option value="">Select</option>

                                          
                                               <option value="AGENT"  @if($user->ROLE === 'AGENT') selected="selected" @endif>AGENT</option>
                                                <option value="AGENT_ADMIN" @if($user->ROLE === 'AGENT_ADMIN') selected="selected" @endif>AGENT_ADMIN</option>
      ...
      <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control required" title="Select company..." name="comp" id="comp">
                                            <option value="">Select</option>
                                            <?php  $cmp = DB::table('company')->get();
											foreach( $cmp  as  $cmps)
											{
											 ?>
                                                <option value="<?Php echo $cmps->id;?>" <?php if($cmps->id==$user->COMPANY_ID){?> selected="selected" <?php }?>><?Php echo $cmps->name;?></option>
                                               <?php
											   }
											    ?>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/wizard/jquery-steps/js/jquery.steps_user.js') }}"></script>
